...
module.exports = new Command({
	name: "about",
	description: "Get information about Gate-Seeker",
	usage: "gs!about",
	...
	async run(message, args, client) {
		try {
			...
			const embed1 = new Discord.EmbedBuilder()
				...
				.setColor("#af4ae9")
				.setDescription(
					"Hi ! I'm Gate-Seeker, a  bot created by CadenEras for players of the mobil game Epic 7 ! Try `gs!help` to start with me !"
				)
				.setAuthor("Gate-Seeker", "https://i.imgur.com/owmcBui.png")
				.addField(`Art by`, `Opheliart#3547 (633310607730278402)`)
				.addField(`Language`, `JavaScript`, true)
				.addField(`Prefix`, `gs!`, true)
				.addField(`Owner`, `CadenEras#2020 (795326819346808832)`, true)
				.addField(`Creation date`, `August 2022`, true)
				.addField(`Maintenance Server`, `https://discord.gg/P7JeGwBRYU`, true)
				.addField(`Repository (GitHub)`, `https://github.com/CadenEras/Gate-Seeker-Discord`, true)
				.addField(
					`Memory usage`,
				...
				.setImage("https://i.imgur.com/owmcBui.png")
				.setTimestamp()
